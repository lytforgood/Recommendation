...
object JDDateTest41 {
  ...
  def main(args: Array[String]) {
    ...
    sc.textFile("/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/action_train.csv").map(x=>{
    ...
    }).repartition(1).saveAsTextFile("/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/x1")
