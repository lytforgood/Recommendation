...
object JDDateFormat02 {
  ...
  def main(args: Array[String]) {
    ...
    val path = "/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/JData_Action_201603.csv"
    ...
    val re = line.filter(x=> !x._3.equals("0")).map(x => {
      ...
      (x._1, x._2, x._3, x._4,x._5,x._6,x._7,x._8,getWeeks(x._3),x._9)
    })

      val re2=re.map(x=>x.toString().replaceAll("\\(","").replaceAll("\\)",""))
      re2.coalesce(1).saveAsTextFile("/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/03")
