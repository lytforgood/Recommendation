...
object JDDateFormat03 {
  ...
  def main(args: Array[String]) {
    ...
    val path = "/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/JData_Action_201604.csv"
    ...
    val re = line.filter(x=> !x._3.equals("0")).map(x => {
      ...
      re2.coalesce(1).saveAsTextFile("/Users/yuyin/Downloads/笔记学习/天池比赛/JD高潜用户购买意向预测/记录/第五周top1_0.197/04")
